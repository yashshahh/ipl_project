    ...
    <section class="py-5">
      <div class="container">
        ...
        <div style="color:white;" class="row">
            <div style="background-color:brown;" class="col">
              <h2 style="padding-top:5px;">Delhi Daredevils</h2>
              <p>Owner: GMR Sports Pvt Ltd</p>
              <p>Coach: Paddy Upton</p>
              <p>Venue: Feroz Shah Kotla Ground</p>
              <p>Captain: Zaheer Khan</p>
            </div>
            <div class="col">
              <center><img src="images/delhi-daredevils-logo.jpg" style="height:200px;width:400px;" class="img-fluid" alt="Responsive image"></center>
            </div>
        </div>
        <br>
        <img src="images/teamcover/delhi.png" class="img-fluid" alt="Responsive image">
        <br>
        <br>
        <h3>Squad List</h3>
